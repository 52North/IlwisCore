...
public:
    ...
    virtual Record& recordRef(const QVariant &trackIndexValue=QVariant(COVERAGEATRIB)) const = 0;
...
private:
    ...
    Record& recordRef(const QVariant &trackIndexValue=QVariant(COVERAGEATRIB)) const;
