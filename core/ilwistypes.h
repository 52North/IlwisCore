...
const quint64 itBOUNDSONLYCSY = 2 * itORTHOCOORDSYSTEM; // 4096
const quint64 itELLIPSOID = 2  * itBOUNDSONLYCSY; // 8192
const quint64 itPROJECTION =  2 * itELLIPSOID;
const quint64 itATTRIBUTETABLE = 2 * itPROJECTION;
const quint64 itFLATTABLE = 2 * itATTRIBUTETABLE;
...
const quint64 itCOORDSYSTEM = itCONVENTIONALCOORDSYSTEM | itORTHOCOORDSYSTEM | itBOUNDSONLYCSY;
const quint64 itTABLE = itFLATTABLE | itATTRIBUTETABLE;
