...
const quint64 itOPERATIONMETADATA = 2 * itGEOREF;      //262144
const quint64 itCATALOG = 2 * itOPERATIONMETADATA;     //524288
...
const quint64 itILWISOBJECT = itCOVERAGE | itDOMAIN | itCOORDSYSTEM | itCATALOG |
         itELLIPSOID | itPROJECTION | itTABLE | itREPRESENTATION | itGEOREF | itOPERATIONMETADATA | itWORKFLOW;
