...
const quint64 itCONVENTIONALCOORDSYSTEM = 2 * itCOLORDOMAIN; //2048
const quint64 itORTHOCOORDSYSTEM = 2 * itCONVENTIONALCOORDSYSTEM; //4096
const quint64 itELLIPSOID = 2  * itORTHOCOORDSYSTEM; // 8192
const quint64 itPROJECTION =  2 * itELLIPSOID; //16384
const quint64 itDATABASETABLE = 2 * itPROJECTION; //32768
const quint64 itFLATTABLE = 2 * itDATABASETABLE; //65536
const quint64 itREPRESENTATION = 2 * itFLATTABLE; //131072
const quint64 itTIEPOINTGEOREF = 2 * itREPRESENTATION; //262144
const quint64 itCORNERSGEOREF = 2 * itTIEPOINTGEOREF; //524288
const quint64 itENVELOPE = 2 * itCORNERSGEOREF; //1048576
const quint64 itOPERATIONMETADATA = 2 * itENVELOPE; //2097152
const quint64 itGRIDSIZE = 2 * itOPERATIONMETADATA; //4194304
const quint64 itCATALOG = 2 * itGRIDSIZE; //8388608
const quint64 itGEODETICDATUM = 2  * itCATALOG; //16777216
const quint64 itBOOL = 2 * itGEODETICDATUM; //33554432
const quint64 itINT8 = 2 * itBOOL; //67108864
const quint64 itUINT8 = 2 * itINT8; //134217728
const quint64 itUINT16 =  2 * itUINT8; //268435456
