...
const quint64 itTIEPOINTGEOREF = 2 * itREPRESENTATION; //524288
const quint64 itCORNERSGEOREF = 2 * itTIEPOINTGEOREF; //1048576
const quint64 itENVELOPE = 2 * itCORNERSGEOREF; //2097152
const quint64 itOPERATIONMETADATA = 2 * itENVELOPE; //4194304
const quint64 itGRIDSIZE = 2 * itOPERATIONMETADATA; //8388608
const quint64 itCATALOG = 2 * itGRIDSIZE; //16777216
const quint64 itGEODETICDATUM = 2  * itCATALOG; //33554432
const quint64 itBOOL = 2 * itGEODETICDATUM; //67108864
const quint64 itINT8 = 2 * itBOOL; //134217728
const quint64 itUINT8 = 2 * itINT8; //268435456
