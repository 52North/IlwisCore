...
CoverageLayerModel::CoverageLayerModel(const Ilwis::Resource &resource, const QList<PropertyEditor *> &editors, QObject *obj) : ResourceModel(resource, obj), _propertyEditors(editors)
{
