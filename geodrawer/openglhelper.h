...
public:
    ...
    static void getVertices(const ICoordinateSystem& csyRoot, const ICoordinateSystem& csyGeom, const UPGeometry& geometry, Raw objectid, std::vector<VertexPosition>& points,  std::vector<VertexIndex>& indices, quint32 &boundaryIndex);
private:
