...
quint64 CreateCornersGeoreference::createMetadata()
{
    ...
    resource.addInParameter(5, itSTRING,TR("Coordinate system"), TR("Coordinate system for which the world coordinates of the georeference are valid"));
    ...
    resource.setKeywords("georeference, create, geometry");
